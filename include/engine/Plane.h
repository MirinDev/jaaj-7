...
static std::vector<Vertex> createPlane(float w, float h, float repeatx, float repeaty, float repeatw, float repeath){
    return std::vector<Vertex>{
        Vertex{glm::vec3(-w/2.0f, -h/2.0f, 0.0f), glm::vec2(repeatx+repeatw, repeaty), glm::vec3(0.0f, 0.0f, -1.0f)},
        Vertex{glm::vec3(w/2.0f, -h/2.0f, 0.0f), glm::vec2(repeatx, repeaty), glm::vec3(0.0f, 0.0f, -1.0f)},
        Vertex{glm::vec3(w/2.0f, h/2.0f, 0.0f), glm::vec2(repeatx, repeaty+repeath), glm::vec3(0.0f, 0.0f, -1.0f)},
        Vertex{glm::vec3(-w/2.0f, h/2.0f, 0.0f), glm::vec2(repeatx+repeatw, repeaty+repeath), glm::vec3(0.0f, 0.0f, -1.0f)},
    };
}
